...
import com.okta.demo.notification.repository.NotificationRepository;
import com.okta.demo.notification.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.okta.demo.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
